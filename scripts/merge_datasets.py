...
t1dexi = pd.read_parquet("raw_data/t1dexi_parsed.parquet")
...
pf = pq.ParquetFile("raw_data/metabonet_train_filtered.parquet")
...
for batch in pf.iter_batches(batch_size=500_000):
    ...
    if writer is None:
        writer = pq.ParquetWriter("raw_data/combined_filtered.parquet", table.schema)
...
print("Saved to raw_data/combined_filtered.parquet")