...
def parse_args():
    ...
    parser.add_argument('--app',          required=True,
                        choices=['forecasting', 'hypo_risk', 'isf_cr', 'digital_twin', 'tir'])
    parser.add_argument('--run_id',       required=True)
    parser.add_argument('--data',         default='data/processed/adults')
    parser.add_argument('--epochs',       type=int,   default=50)
    parser.add_argument('--mode',         default='both', choices=['fm', 'ts', 'both'])
    parser.add_argument('--lr',           type=float, default=1e-3)
    parser.add_argument('--lr_ts',        type=float, default=1e-4)
